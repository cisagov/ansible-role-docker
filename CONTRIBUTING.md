...
issue](https://github.com/cisagov/ansible-role-docker/issues) in
...
request](https://github.com/cisagov/ansible-role-docker/pulls), you
...
pyenv virtualenv <python_version_to_use> ansible-role-docker
pyenv local ansible-role-docker
